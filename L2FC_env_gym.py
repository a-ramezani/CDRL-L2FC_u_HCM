...
class L2FC_env(gym.Env):
    ...
    def __init__(self, algo_name, silent_mode):
        ...
        self.step=self.rotors_bc_continuous_step
        self.reset=self.rotors_bc_reset

    def render(self, mode='human', close=False): # for gym environment
        return True
        ####
